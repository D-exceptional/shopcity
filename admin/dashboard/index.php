<?php 
  ...
  $productStats = $productModel->getAdminProductStats();
  $storeStats   = $storeModel->countStoresByStatus();
  $walletStats  = $walletModel->getAdminWalletStats($userId);
  $mailStats    = $mailModel->getAdminMailStats($email, $fullName);
  $notificationStats = $notificationModel->getAdminNotificationStats($userId);
?>   

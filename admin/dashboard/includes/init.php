...
// -------------------------------------------------------------------
$authUrl = $_ENV['ADMIN_LOGIN_PATH'] ?? rtrim(dirname($_SERVER['SCRIPT_NAME']), '/') . '/admin';
...
if ($isLoggedIn === true) {
    ...
    $profile = ($avatar === 'None') ? rtrim(dirname($_SERVER['SCRIPT_NAME'], 3), '/') . '/assets/img/avatar.jpg' : $avatar;
} 
else{

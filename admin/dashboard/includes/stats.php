...
<div class="col-lg-3 col-6 dashboard-item">
    <div class="small-box bg-info bg-transparent border-primary color-primary">
        <div class="inner d-flex">
            ...
            <div class="info-div w-80 d-flex flex-direction-column align-items-end justify-content-end wrap p-info">
                <h3 class="text-center"><?= $ratingManager->format($productStats['total']  ?? 0); ?></h3>
                <p>Total Products</p>
            </div>
        </div>
        <a href="#" class="small-box-footer bg-primary color-primary color-white"></a>
...
<div class="col-lg-3 col-6 dashboard-item">
    <div class="small-box bg-info bg-transparent border-primary color-primary">
        <div class="inner d-flex">
            ...
            <div class="info-div w-80 d-flex flex-direction-column align-items-end justify-content-end wrap p-info">
                <h3 class="text-center"><?= $ratingManager->format((float)$storeStats['Pending'] ?? 0); ?></h3>
                <p>Pending Stores</p>
            </div>
        </div>
        <a href="#" class="small-box-footer bg-primary color-primary color-white"></a>
...
<div class="col-lg-3 col-6 dashboard-item p-100">
    <div class="small-box bg-info bg-transparent border-primary color-primary">
        <div class="inner d-flex">
            ...
            <div class="info-div w-80 d-flex flex-direction-column align-items-end justify-content-end wrap p-info">
                <h3 class="text-center"><?= $ratingManager->format((float)$notificationStats['unread'] ?? 0); ?></h3>

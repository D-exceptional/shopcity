<?php 
  ...
  $inboxMails = $mailModel->getInbox($email, $page);
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>Inbox (<?= $ratingManager->format($inboxMails['total']) ?>)</b></h1>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card-body p-0">
                <div class="mailbox-controls">
                  ...
                  <div class="float-right">
                    ...
                    <div class="btn-group">
                      <button type="button" class="btn btn-default btn-sm">
                        <a href="<?= ($currentPage > 1) ? pageUrl($currentPage - 1, $baseUrl) : '#' ?>" class='inbox-previous view-link' data-total='<?= $totalPages ?>'>
                          <i class="fas fa-chevron-left"></i>
                        </a>
                      </button>
                      <button type="button" class="btn btn-default btn-sm">
                         <a href="<?= ($currentPage < $totalPages) ? pageUrl($currentPage + 1, $baseUrl) : '#' ?>" class='inbox-next view-link' data-total='<?= $totalPages ?>'>

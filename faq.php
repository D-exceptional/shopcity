...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6 wow fadeInUp" data-wow-delay="0.1s">FAQ</h1>
    ...
    <div class="container-fluid contact py-5">
        <div class="container py-5">
            <div class="p-5 bg-light rounded">
                <div class="row g-4">
                    <div class="col-lg-7">
                        <h5 class="text-primary wow fadeInUp" data-wow-delay="0.1s">Frequently Asked Questions</h5>
                        ...
                        <!--- Add More Info Below -->
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3 btn-doc" data-doc="frequently-asked-questions.pdf">View FAQ Document</button>
                        </div>
                    </div>

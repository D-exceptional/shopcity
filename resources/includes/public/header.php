...
<!-- Topbar Start -->
<div class="container-fluid px-5 d-none border-bottom d-lg-block top-bar <?= $isLoggedIn ? 'logged-in' : 'logged-out' ?>" 
    data-uid="<?= $isLoggedIn ? $userId : null ?>"
>
    <div class="row gx-0 align-items-center">
        ...
        <div class="col-lg-4 text-center d-flex align-items-center justify-content-center">
            ...
            <a href="#" class="text-muted"> support@<?= strtolower($appName) ?>.com</a>
        </div>
            ...
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu rounded">
                        ...
                        <a href="/track" class="dropdown-item">Track Order</a>
                        <a href="/wallet" class="dropdown-item">Wallet</a> 
                        <a href="<?= $isLoggedIn ? '#' : '/auth/user/login' ?>" class="dropdown-item header-log"><?= $isLoggedIn ? 'Log Out' : 'Login' ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid px-5 py-4 d-none d-lg-block bg-primary">
    <div class="row gx-0 align-items-center text-center">
        <div class="col-md-4 col-lg-3 text-center text-lg-start">
            <div class="d-inline-flex align-items-center">
                <a href="/" class="navbar-brand p-0">
                    <h1 class="display-5 text-primary m-0" style="color: #fff !important;"><?= $appName ?></h1>
        ...
        <div class="col-md-4 col-lg-6 text-center">
            <div class="position-relative ps-4">
                <div class="d-flex border rounded-pill">
                    <input class="form-control text-white border-0 rounded-pill w-100 py-3 bg-transparent main-search" type="text" 
                        data-bs-target="#dropdownToggle123" placeholder="Search electronics, clothes, jewelries, appliances..."
                    >
        ...
        <div class="col-md-4 col-lg-3 text-center text-lg-end">
            <div class="d-inline-flex align-items-center">
                <a href="/support" class="text-muted d-flex align-items-center justify-content-center me-3">
                    <span class="rounded-circle btn-md-square border">
                        <i class="fa fa-user-shield"></i>
                    </span>
                </a>
                <a href="/wishlist" class="text-muted d-flex align-items-center justify-content-center me-3">
                    <span class="rounded-circle btn-md-square border">
        ...
        <div class="col-12 col-lg-9">
            <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                <a href="/" class="navbar-brand d-block d-lg-none">
                    <h1 class="display-5 text-secondary m-0" style="color: #fff !important;"><?= $appName ?></h1>
                    <!-- <img src="assets/img/logo.png" alt="Logo"> -->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <?php if(!$isLoggedIn): ?>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0">
                                    <a href="/auth/user/register?type=customer" class="dropdown-item">Customer</a>
                                    <a href="/auth/user/register?type=vendor" class="dropdown-item">Seller</a>
                                </div>
                            </div>
                    ...
                    <a href="<?= $isLoggedIn ? '#' : '/auth/user/login' ?>" class="btn btn-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0 btn-call" 
                        style="background-color: #34302f61 !important;border: 1px solid gray"
                    >
                        <i class="fa fa-sign-in-alt me-2"></i> <?= $isLoggedIn ? 'Logout' : 'Login' ?>
                    </a>
                </div>
            </nav>
        </div>

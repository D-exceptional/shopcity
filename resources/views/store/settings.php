...
<body class="hold-transition sidebar-mini">
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item">
                      <a class="nav-link active bg-transparent color-primary border-primary mgr-5" href="#details" data-toggle="tab">
                        <b>Details</b>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link bg-transparent color-primary border-primary mgr-5" href="#socials" data-toggle="tab">
                        <b>Socials</b>
                      </a>
                    </li>
                  </ul>
                    ...
                    <div class="tab-pane" id="details" style="display: block;">
                      <form class="form-horizontal">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input data-type="name" type="text" class="form-control form-name form-text" name="name" 
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input data-type="aplha-numeric" type="text" class="form-control form-delivery form-text" name="delivery" 
                              value='<?= $storeDetails['store_delivery'] ?>'
                            >
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="status" 
                              value='<?= $storeDetails['store_status'] ?>' 
                              disabled
                            >
                          </div>
                        </div>
                    ...
                    <div class="tab-pane" id="socials">
                      <form class="form-horizontal">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-facebook form-social" data-type="all" name="facebook" 
                              value='<?= $storeDetails['facebook'] ?? 'Not set' ?>' placeholder="Facebook"
                            >
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-instagram form-social" data-type="all" name="instagram" 
                              value='<?= $storeDetails['instagram'] ?? 'Not set' ?>' placeholder="Instagram"
                            >
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-tiktok form-social" data-type="all" name="tiktok" 
                              value='<?= $storeDetails['tiktok'] ?? 'Not set' ?>' placeholder="Tiktok"
                            >
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-twitter form-social" data-type="all" name="twitter" 
                              value='<?= $storeDetails['twitter'] ?? 'Not set' ?>' placeholder="Twitter"
                            >
                          </div>
                        </div>
                        <div class="form-group row">
  ...
  <!-- Custom Scripts -->
  <script src="<?= asset_versioned('js/store/details.js'); ?>" type='module'></script>
  <script src="<?= asset_versioned('js/store/profile.js'); ?>" type='module'></script>
  <script src="<?= asset_versioned('js/store/socials.js'); ?>" type='module'></script>

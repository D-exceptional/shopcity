<?php 
  ...
  $orderModel   =  $app->container()->get(\App\Models\Order::class);
  $productModel =  $app->container()->get(\App\Models\Product::class);
  $storeModel   =  $app->container()->get(\App\Models\Store::class);
  $walletModel  =  $app->container()->get(\App\Models\Wallet::class); 
  $mailModel    =  $app->container()->get(\App\Models\Mail::class); 

  // Get combined sales stats
  $orderStats        = $orderModel->getVendorOrderStats($userId);
  $productStats      = $productModel->getVendorProductStats($userId);
  $storeStats        = $storeModel->getVendorStoreStats($userId);
  $walletStats       = $walletModel->getVendorWalletStats($userId);
  $mailStats         = $mailModel->getVendorMailStats($email, $fullName);
  $notificationStats = $notificationModel->getVendorNotificationStats($userId);
?>  

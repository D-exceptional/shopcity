                  ...
                  <?php if (!empty($withdrawals)): ?>
                    ...
                    <?php foreach ($withdrawals as $withdrawal): ?>
                      ...
                      <tr data-id='<?= $withdrawal['withdrawal_id'] ?>'>
                        <td>#</td>
                        <td><?= $currencyManager->format((float)$withdrawal['amount'] ?? 0); ?></td>
  ...
  <div class='overlay'>
    <form class="form-horizontal form-withdrawal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="number" class="form-control available_amount" name="available_amount" value="<?= $walletBalance ?>" disabled>
        </div>
      </div>
      <div class="form-group">
          <div class='form-text'>

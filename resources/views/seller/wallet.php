            ...
            <table class="table table-striped projects">
              ...
              <tbody>
                <?php if ($isLoggedIn): ?>
                  ...
                  <tr>
                    <td>#</td>
                    <td><?= $currencyManager->format((float)$walletStats['current_balance'] ?? 0); ?></td>
                    <td><?= $currencyManager->format((float)$walletStats['total_balance'] ?? 0); ?></td>
                    <td><?= $currencyManager->format((float)$walletStats['savings_balance'] ?? 0); ?></td>
                    <td><?= $currencyManager->format((float)$walletStats['pending_payout'] ?? 0); ?></td>
                    <td><?= $currencyManager->format((float)$walletStats['total_payout'] ?? 0); ?></td>
                    <td>

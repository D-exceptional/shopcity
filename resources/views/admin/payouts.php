<?php 
  ...
  // Base Pagination URL
  $baseUrl = "/admin/payouts/status/{$status}";
?> 
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper" data-status="<?= $status ?>">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b><?= $status ?> Payouts (<?= $numberManager->format($paymentList['total']) ?>)</b></h1>
            </div>
            <div class="col-sm-6">
  ...
  <!-- Custom Scripts -->
  <script src="<?= asset_versioned('js/admin/payouts.js'); ?>" type="module"></script>

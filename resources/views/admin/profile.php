...
<body class="hold-transition sidebar-mini">
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                      <a class="nav-link bg-transparent color-primary border-primary" href="#security" data-toggle="tab">
                        <b>Security</b>
                      </a>
                    </li>
                  </ul>
                    ...
                    <div class="tab-pane" id="security">
                      <form class="form-horizontal">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-password form-security" data-type="all" name="current_password" 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control form-repassword form-security" data-type="all" name="new_password" 
  ...
  <!-- Custom Scripts -->
  <script src="<?= asset_versioned('js/admin/profile.js'); ?>" type='module'></script>
  <script src="<?= asset_versioned('js/admin/security.js'); ?>" type='module'></script>
</body>
</html>

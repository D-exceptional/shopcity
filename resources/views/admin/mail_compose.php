...
<body class="hold-transition sidebar-mini">
              ...
              <?php if (!empty($allAdmins)): ?>
                ...
                <?php foreach ($allAdmins as $recipient): ?>
                  ...
                  <?php
                    ...
                    $displayAvatar     = 'img/avatar.jpg';
                  ?>

                  <div class='user-card'>
                    <div class='user-card-image' title='<?= $recipient['email'] ?>'>
                      <img src='<?= asset($displayAvatar) ?>' alt='admin-image'>
                    </div>
            ...
            <div class='user-scroll' id='customer-section'>
              ...
              <?php if (!empty($allCustomers)): ?>
                ...
                <?php foreach ($allCustomers as $recipient): ?>
                  ...
                  <div class='user-card'>
                    <div class='user-card-image' title='<?= $recipient['email'] ?>'>
                      <img src='<?= asset($displayAvatar) ?>' alt='customer-image'>
                    </div>
                    <div class='user-card-name'>
                      <?= $recipientFullname ?>
                    </div>
            ...
            <div class='user-scroll' id='vendor-section'>
              ...
              <?php if (!empty($allVendors)): ?>
                ...
                <?php foreach ($allVendors as $recipient): ?>
                  ...
                  <div class='user-card'>
                    <div class='user-card-image' title='<?= $recipient['email'] ?>'>
                      <img src='<?= asset($displayAvatar) ?>' alt='vendor-image'>
                    </div>
                    <div class='user-card-name'>
                      <?= $recipientFullname ?>
                    </div>
  ...
  <!-- Custom Scripts -->
  <script src="<?= asset_versioned('js/admin/mail-compose.js') ?>" type='module'></script>

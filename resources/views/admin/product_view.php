...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-9">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="featured">Featured? (For Paid Promotion)</label>
                                        <select name="featured" class="form-control form-featured">
                                            <option value="<?= $productDetails['is_featured'] ?>" selected><?= $productDetails['is_featured'] ?></option>

                                            <?php if (!empty($productDetails['is_featured'])): ?>

                                                <?php
                                                    $reverseVisibility = $productDetails['is_featured'] === TRUE ? FALSE : TRUE;
                                                ?>
   ...
   <!-- Custom Scripts -->
   <script src="<?= asset_versioned('js/admin/product-details.js'); ?>" type="module"></script>
</body>
</html>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1><b>Outbox (<?= $numberManager->format($outboxMails['total']) ?>)</b></h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="btn-group">
                     <button type="button" class="btn btn-default btn-sm">
                        <a href="<?= ($currentPage > 1) ? page_url($currentPage - 1, $baseUrl) : '#' ?>" 
                          class='outbox-previous view-link' data-total='<?= $totalPages ?>'
                        >
                      ...
                      <button type="button" class="btn btn-default btn-sm">
                         <a href="<?= ($currentPage < $totalPages) ? page_url($currentPage + 1, $baseUrl) : '#' ?>" 
                          class='outbox-next view-link' data-total='<?= $totalPages ?>'
                          >

...
<body class="hold-transition sidebar-mini">
                ...
                <?php if (!empty($storeList)): ?>
                  ...
                  <?php foreach ($storeList as $store): ?>
                    ...
                    <tr class='content-row' data-id='<?=$store['store_id'] ?>'>
                      ...
                      <td>
                        <img src='<?= $store['store_avatar'] ?>' class='profile-user-img img-fluid hmg-100 border-radius-10' 
                          alt='Store Image'
                        >
                      </td>
                      <td class='status'>
                  ...
                  <?php else: ?>
                    <tr>
                      <td colspan="11" class='text-center'>No stores available</td>
                    </tr>
  ...
  <!-- Custom Scripts -->
  <script src="<?= asset_versioned('js/admin/store-list.js'); ?>" type="module"></script>

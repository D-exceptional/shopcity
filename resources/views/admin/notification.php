...
<body class="hold-transition sidebar-mini">
                  ...
                  <?php foreach ($adminNotifications as $notification): ?>
                    ...
                    <?php
                      ...
                      $iconMap = [
                        ...
                        'New Registration'   => ['fas fa-user-plus', 'bg-blue'],
                        'New Store'          => ['fas fa-university', 'bg-blue'],
                        'New Product'        => ['fas fa-layer-group', 'bg-yellow'],
                      ];
  ...
  <script src="<?= asset_versioned('js/admin/notifications.js'); ?>" type="module"></script>
</body>
</html>

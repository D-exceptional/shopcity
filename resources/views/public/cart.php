...
<body>
                            ...
                            <div class="bg-light rounded">
                                <div class="p-4">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <p class="mb-0">
                                                Flat rate: <?= $currencyManager->format((float)FLAT_RATE); ?>
                                            </p>
                                        </div>
                                    </div>
    ...
    <script src="<?= asset_versioned('js/public/cart.js'); ?>" type="module"></script>

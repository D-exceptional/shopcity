<?php
    ...
    $totalPages  = $pageProducts['total_pages'];
    $currentPage = $pageProducts['page'];
    $baseUrl     = "/products/{$filter}/{$value}";
?>
...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6 wow fadeInUp" data-wow-delay="0.1s">Product List</h1>
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInUp" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="/">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Pages</a></li>
            <li class="breadcrumb-item active text-white">Product List</li>
        </ol>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <?php foreach ($groupedCategories as $category): ?>
                                    ...
                                    <li>
                                        <div class="categories-item">
                                            <a href="/products/category/<?= urlencode($category['category_name']) ?>/page/1">
                                ...
                                <?php foreach ($productColors as $color): ?>
                                    ...
                                    <li>
                                        <div class="product-color-item">
                                            <a href="/products/color/<?= urlencode($color['color']) ?>/page/1">
                                                <i class="fas fa-palette text-primary me-2"></i>
                                                <?= htmlspecialchars($color['color']) ?>
                                            </a>
                                            <span>(<?= (int)$color['product_count'] ?>)</span>
                                        </div>
                                    </li>
                    ...
                    <div class="price mb-4">
                        ...
                        <input type="range" class="form-range w-100" id="rangeInput" name="rangeInput" min="1000" max="10000000" value="1000" step="1000" 
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-3 text-end">
                            <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between">
                                ...
                                <?php include_once ROOT_DIR_PATH . '/includes/public/filter.php'; ?>
                            </div>
                        </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-5" class="tab-pane fade show p-0 active">
                            <div class="row g-4 product product-main">
                                ...
                                <?php if (!empty($pageProducts['products'])): ?>

                                    <!-- Display All Products -->
                                    <?php foreach ($pageProducts['products'] as $product): ?>
                                            ...
                                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                                <div class="product-item-inner border rounded">
                                                    <div class="product-item-inner-item">
                                                        <img src="<?= htmlspecialchars($imageUrl) ?>" class="img-fluid w-100 rounded-top product-image" 
                                                            alt="Product Image"
                                                        >
                                                    ...
                                                    <div class="text-center rounded-bottom p-4">
                                                        <a href="/products/category/<?= htmlspecialchars($product['category']) ?>/page/1" 
                                                            class="d-block mb-2 product-category"
                                                        >
                                                            <?= htmlspecialchars($product['category']) ?>
                                                        </a>
                                                        <a href="/product/<?= $product['product_id'] ?>" class="d-block h4 product-name">
                                                            <?= htmlspecialchars($product['product_name']) ?>
                                                        </a>
                                    ...
                                    <div class="col-12 wow fadeInUp pagination-row" data-wow-delay="0.1s">
                                        <div class="pagination d-flex justify-content-center mt-5">
                                            ...
                                            <?php for ($page = 1; $page <= $totalPages; $page++): ?>
                                                ...
                                                <a href="<?= page_url($page, $baseUrl) ?>" 
                                                    class="<?= ($page == $currentPage) ? 'active' : '' ?> rounded"
                                                >
                                                    <?= $page ?>
                                                </a>
                                        ...
                                        <div class="col-lg-6 product-card card-main" data-id="<?= $product['product_id'] ?>">
                                            <div class="products-mini-item border">
                                                <div class="row g-0">
                                                    <div class="col-5">
                                                        <div class="products-mini-img border-end h-100">
                                                            <img src="<?= htmlspecialchars($imageUrl) ?>" class="img-fluid w-100 h-100 product-image" 
                                                                alt="Product Image"
                                                            >
                                                ...
                                                <div class="products-mini-add border p-3">
                                                    <a href="#" class="btn btn-primary border-primary rounded-pill py-2 px-4 cart-add 
                                                        <?= $isLoggedIn ? 'cart-user' : 'cart-guest' ?>"
                                                    >
                                                        <i class="fas fa-shopping-cart me-2"></i> Add To Cart
                                                    </a>

            ...
            <div class="related-carousel owl-carousel pt-4">
                ...
                <?php foreach ($topBrands['brands'] as $store): ?>
                    ...
                    <?php
                        ...
                        $imageUrl = $store['store_avatar'] ?? null; 
                    ?>
                        ...
                        <div class="related-item-inner border rounded">
                            <div class="related-item-inner-item">
                                ...
                                <div class="related-details">
                                    <a href="/store/<?= $store['store_id'] ?>"><i class="fa fa-eye fa-1x"></i></a>
                                </div>
                            </div>
                            <div class="text-center rounded-bottom p-4">
                                <a href="#" class="d-block mb-2"><?= ($store['product_count'] > 1000) ? 'Best-selling Brand' : 'Top Brand' ?></a>
                                <a href="/store/<?= $store['store_id'] ?>" class="d-block h4"><?= htmlspecialchars($store['store_name']) ?></a>
                                <span class="text-muted font-normal">

                                    <?php

                                        $description = strip_tags($store['store_description'] ?? ''); // Remove HTML tags just in case
                                        $shortIntro  = mb_substr($description, 0, 100); // Get first 100 characters safely (supports UTF-8)

                                        if (mb_strlen($description) > 100) {
                                            $shortIntro.= '...';
                                        }

                                        echo htmlspecialchars($shortIntro);
                                    ?>

                                </span>
                            </div>
                            <div class="product-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                                <a href="/store/<?= $store['store_id'] ?>" class="btn btn-primary border-primary rounded-pill py-2 px-4 mb-4">
                                    <i class="fas fa-arrow-right me-2"></i> View Brand
                                </a>
                ...
                <div class="pagination d-flex justify-content-center">
                    ...
                    <?php if (!empty($topBrands['brands'])): ?>
                        ...
                        <?php for ($page = 1; $page <= $totalPages; $page++): ?>
                            ...
                            <a href="<?= page_url($page, $baseUrl) ?>" class="<?= ($page == $currentPage) ? 'active' : '' ?> rounded">
                                <?= $page ?>
                            </a>
                    ...
                    <a href="#">
                        <div class="bg-primary rounded position-relative">
                            ...
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                ...
                                <a href="/" class="btn btn-primary rounded-pill align-self-start py-2 px-4">
                                    Shop Now
                                </a>
                            </div>
                        </div>
                    ...
                    <a href="#">
                        <div class="text-center bg-primary rounded position-relative">
                            ...
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                ...
                                <a href="/" class="btn btn-secondary rounded-pill align-self-center py-2 px-4">
                                    Shop Now
                                </a>
                            </div>
                        </div>

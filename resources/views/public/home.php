        ...
        <div class="row g-0 justify-content-end">
            ...
            <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
                <div class="carousel-header-banner h-100">
                    <img src="<?= asset('img/ads-2.jpg') ?>" class="img-fluid w-100 h-100" style="object-fit: cover;object-position: center;" alt="Image">
                    ...
                    <div class="featured-product mb-4">
                        ...
                        <?php foreach ($featuredProducts['products'] as $product): ?>
                            ...
                            <div class="featured-product-item" data-id="<?= $product['product_id'] ?>">
                                ...
                                <div>
                                    <h6 class="mb-2">
                                        <a href="/product/<?= $product['product_id'] ?>" class="text-dark product-category">
                                            <?= htmlspecialchars($product['product_name']) ?>
                                        </a>
                                    </h6>
                                ...
                                <div class="col-5">
                                    <div class="products-mini-img border-end h-100">
                                        ...
                                        <div class="products-mini-icon rounded-circle bg-view">
                                            <a href="/product/<?= $product['product_id'] ?>"><i class="fa fa-eye fa-1x text-white"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-7">

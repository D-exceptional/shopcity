<?php
    ...
    $totalPages  = $matchedProducts['total_pages'];
    $currentPage = $matchedProducts['page'];
    $baseUrl     = "/product/{$search}/search";
?>
...
<head>
    <title><?= $appName ?> | Search Result</title>
...
<body>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6 wow fadeInUp" data-wow-delay="0.1s">Search Result</h1>
                            ...
                            <?php foreach ($groupedCategories as $category): ?>
                                ...
                                <li>
                                    <div class="categories-item">
                                        <a href="/products/category/<?= $category['category_name'] ?>/page/1">
                            ...
                            <?php foreach ($productColors as $color): ?>
                                ...
                                <li>
                                    <div class="product-color-item">
                                        <a href="/products/color/<?= $color['color'] ?>/page/1">
                    ...
                    <div class="tab-content">
                        <div id="tab-5" class="tab-pane fade show p-0 active">
                            <div class="row g-4 product product-main">
                                ...
                                <?php if (!empty($matchedProducts['products'])): ?>

                                    <!-- Display All Products -->
                                    <?php foreach ($matchedProducts['products'] as $product): ?>
                                            ...
                                            <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                                <div class="product-item-inner border rounded">
                                                    ...
                                                    <div class="text-center rounded-bottom p-4">
                                                        ...
                                                        <a href="/product-details?id=<?= $product['product_id'] ?>" class="d-block h4 product-name">
                                                            <?= htmlspecialchars($product['product_name']) ?>
                                                        </a>

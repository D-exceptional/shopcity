...
<head>
    <title><?= $appName ?> | Product Details</title>
            ...
            <div class="row g-4">
                <div class="col-lg-5 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="input-group w-100 mx-auto d-flex mb-4">
                        <input type="search" class="form-control p-3 collection-search" data-type="text" placeholder="Search categories, collecti..." 
                            ...
                            <?php foreach ($groupedCategories as $category): ?>
                                ...
                                <li>
                                    <div class="categories-item">
                                        <a href="/products/category/<?= htmlspecialchars($category['category_name']) ?>/page/1">
                    ...
                    <div class="product-categories mb-4 dropdown-menu-height">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <?php foreach ($productColors as $color): ?>
                                ...
                                <li>
                                    <div class="categories-item">
                                        <a href="/products/color/<?= htmlspecialchars($color['color']) ?>/page/1">
                        ...
                        <h4 class="mb-3">Featured products</h4>
                            ...
                            <?php foreach ($featuredProducts['products'] as $product): ?>
                                ...
                                <div class="featured-product-item" data-id="<?= $product['product_id'] ?>">
                                    ...
                                    <div>
                                        <h6 class="mb-2">
                                            <a href="/product/<?= $product['product_id'] ?>" class="text-dark product-name">
                                                <?= htmlspecialchars($product['product_name']) ?>
                                            </a>
                                        </h6>

                                        <?= $rateManager->render($product['rating']['average']); ?>

                                        <div class="d-flex mb-2 mt-2">
                                            <h5 class="fw-bold me-2 price-tag">
                                                <?= $currencyManager->format((float)$product['product_price'] ?? 0); ?>
                                            </h5>
                                            <h5 class="text-danger text-decoration-line-through price-slash">
                                                <?= $currencyManager->format((float)$product['slash_price'] ?? 0); ?>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-4 single-product product-card product-details" data-id="<?= $productDetails['product_id'] ?>">
                                        ...
                                        <div class="single-item"
                                            data-dot="
                                                <?php if ($isImage): ?>
                                                    ...
                                                    <img class='img-fluid' src='<?= htmlspecialchars($mediaUrl) ?>' 
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <img class='img-fluid' src='<?= asset('img/default-product.png') ?>' 
                                                        alt='<?= htmlspecialchars($productDetails['product_name']) ?>'
                                                    >
                        ...
                        <div class="col-xl-6">
                            ...
                            <p class="mb-3 product-category">
                                <?= htmlspecialchars($productDetails['category']) ?>
                            </p>
                            <h5 class="fw-bold mb-3 price-tag">
                                <?= $currencyManager->format((float)$productDetails['product_price'] ?? 0); ?>
                            </h5>
                            <p class="mb-3 price-slash display-none">
                                <?= $currencyManager->format((float)$productDetails['slash_price'] ?? 0); ?>
                            </p>

                            <?= $rateManager->render($productDetails['rating']['average']); ?>
                            ...
                            <div class="d-flex flex-column mb-3">
                                ...
                                <small>Available: 
                                    <strong class="text-primary">
                                        <?= htmlspecialchars($productDetails['stock']) ?> items in stock
                                    </strong>
                                </small>
                                <small>Store Front: 
                                    <strong class="text-primary">
                                        <a href="/store/<?= htmlspecialchars($productDetails['store_id']) ?>">Visit Store</a>
                                    </strong>
                                </small>
                            </div>
                            <p class="mb-4">
                            ...
                            <a href="#" class="btn btn-primary border border-primary rounded-pill px-4 py-2 mb-4 text-primary cart-add 
                                <?= $isLoggedIn ? 'cart-user' : 'cart-guest' ?> cart-primary"
                            >
                        ...
                        <div class="col-lg-12">
                            <nav>
                                <div class="nav nav-tabs mb-3">
                                    <button class="nav-link active border-white border-bottom-0" type="button" role="tab" id="nav-about-tab" data-bs-toggle="tab" 
                                        data-bs-target="#nav-about" aria-controls="nav-about" aria-selected="true"
                                    >
                                        Description
                                    </button>
                                    <button class="nav-link border-white border-bottom-0" type="button" role="tab" id="nav-mission-tab" data-bs-toggle="tab" 
                                        data-bs-target="#nav-mission" aria-controls="nav-mission" aria-selected="false"
                                    >
                                        Reviews
                                    </button>
                                </div>
                                    ...
                                    <?php if (!empty($productDetails['reviews'])): ?>
                                        ...
                                        <?php foreach ($productDetails['reviews'] as $review): ?>
                                            ...
                                            <div class="d-flex border-bottom pb-3 mb-3">
                                                <!-- Avatar -->
                                                <img src="<?= htmlspecialchars(($review['avatar'] !== 'None') ? $review['avatar'] : asset('img/avatar.jpg')) ?>"
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="d-flex mb-3">
                                                            <?= $rateManager->render($review['rating']); ?>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="border-bottom rounded">
                                        <input type="text" class="form-control border-0 me-4 form-name" placeholder="Your Name *" 
                                            value="<?= $isLoggedIn ? htmlspecialchars($user['name']) : '' ?>" disabled
                                        >
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="border-bottom rounded">
                                        <input type="email" class="form-control border-0 form-email" placeholder="Your Email *" 
                                            value="<?= $isLoggedIn ? htmlspecialchars($user['email']) : '' ?>" disabled
                                        >
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex justify-content-between py-3 mb-5">
                                        ...
                                        <a href="#" class="btn btn-primary border border-primary text-primary rounded-pill px-4 py-3 btn-review">
                                            <?= $isLoggedIn ? 'Post Review' : 'Login' ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="related-item-inner border rounded">
                                <div class="related-item-inner-item">
                                    ...
                                    <div class="related-details">
                                        <a href="/product/<?= $product['product_id'] ?>"><i class="fa fa-eye fa-1x"></i></a>
                                    </div>
                                </div>
                                <div class="text-center rounded-bottom p-4">
                                    <a href="/products/category/<?= htmlspecialchars($product['category']) ?>/page/1" class="d-block mb-2">
                                        <?= htmlspecialchars($product['category']) ?>
                                    </a>
                                    <a href="/product/<?= $product['product_id'] ?>" class="d-block h4">
                                        <?= htmlspecialchars($product['product_name']) ?>
                                    </a>
                                    <del class="me-2 fs-5 price-slash">
                                        <?= $currencyManager->format((float)$product['slash_price'] ?? 0); ?>
                                    </del>
                                    <span class="text-primary fs-5 price-tag">
                                        <?= $currencyManager->format((float)$product['product_price'] ?? 0); ?>
                                    </span>
                                </div>
                            </div>
                            <div class="related-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                                <a href="#" class="btn btn-primary border-primary rounded-pill py-2 px-4 mb-4 cart-add 
                                    <?= $isLoggedIn ? 'cart-user' : 'cart-guest' ?>"
                                >
                                ...
                                <div class="d-flex">
                                        ...
                                        <a href="#" class="text-primary d-flex align-items-center justify-content-center me-0 wishlist-add 
                                            <?= $isLoggedIn ? 'wishlist-user' : 'wishlist-guest' ?>"
                                        >
                                            <span class="rounded-circle btn-sm-square border">

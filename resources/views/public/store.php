...
<body>
    ...
    <div class="container-fluid page-header py-5">
        ...
        <div class="text-white mb-3 text-center p-shop-10">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-9 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="rounded mb-4 position-relative">
                        <img src="<?= $storeDetails['store_avatar'] ?? asset('img/product-banner-3.jpg') ?>" class="img-fluid rounded w-100" style="height: 250px;"
                            alt="Image">

<?php
    ...
    $baseUrl     = "/store/{$storeId}/{$filter}/{$value}";
?>
                                ...
                                <?php foreach ($storeCategories as $category): ?>
                                    ...
                                    <li>
                                        <div class="categories-item">
                                            <a href="/store/<?= $storeId ?>/category/<?= $category['category_name'] ?>/page/1">
                                ...
                                <?php foreach ($storeColors as $color): ?>
                                    ...
                                    <li>
                                        <div class="product-color-item">
                                            <a href="/store/<?= $storeId ?>/color/<?= $color['color'] ?>/page/1">
                                                ...
                                                <div class="product-item-inner border rounded">
                                                    ...
                                                    <div class="text-center rounded-bottom p-4">
                                                        <a href="/products/category/<?= htmlspecialchars($product['category']) ?>/page/1" 
                                                            class="d-block mb-2 product-category"><?= htmlspecialchars($product['category']) ?>
                                                        </a>

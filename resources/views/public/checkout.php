...
<body>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="form-item form-location">
                                    ...
                                    <input type="text" class="form-control delivery-address" 
                                        data-type="location" 
                                        data-name="Address" 
                                        value="<?= ($isLoggedIn && !empty($billingDetails)) ? $billingDetails['delivery_address'] : 'Enter Delivery' ?>"
                                    >
                                </div>
                                <div class="form-item form-location">
                                    <label class="form-label my-3">Town/City<sup>*</sup></label>
                                    <input type="text" class="form-control delivery-city" 
                                        data-type="location" 
                                        data-name="City" 
                                        value="<?= ($isLoggedIn && !empty($billingDetails)) ? $billingDetails['city'] : 'Enter Town or City' ?>"
                                    >
                                </div>
                                <div class="form-item form-location">
                                    <label class="form-label my-3">Postcode/Zip<sup>*</sup></label>
                                    <input type="text" class="form-control delivery-postcode" 
                                        data-type="numeric" 
                                        data-name="Postcode" 
                                ...
                                <div class="form-item form-note">
                                    ...
                                    <textarea name="text" class="form-control delivery-note" data-type="alpha-numeric" spellcheck="false" cols="30" rows="11" 
                                ...
                                <!--------------- Create Account ----------------->
                                <div class="form-check my-3">
                                    <p>Don't have an account? <a href="/register?type=customer">Create an account</a></p>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-4">
                                                    <div class="py-2 text-center border-bottom border-top">
                                                        <p class="mb-0 text-dark subtotal">
                                                            <?= $currencyManager->format((float)$totalAmount ?? 0); ?>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3" class="py-4">
                                                    <div class="form-check text-start">
                                                        <input type="radio" class="form-check-input bg-primary border-0 flat-rate" id="Shipping-2" name="Shipping" 
                                                            value="<?= FLAT_RATE ?>"
                                                        >
                                                        <label class="form-check-label" for="Shipping-2">
                                                            Flat rate: <?= $currencyManager->format((float)FLAT_RATE ?? 0); ?>
                                                        </label>
                                                    </div>
                                                    <div class="form-check text-start">
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-4">
                                                    <div class="py-2 text-center border-bottom border-top">
                                                        <p class="mb-0 text-dark checkout-total">
                                                            <?= $currencyManager->format((float)$totalAmount + (float)FLAT_RATE); ?>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="row gap-6 coupon-section">
                                    <div class="col-5 d-flex align-items-center justify-content-center">
                                        <input type="text" class="form-control border-0 border-bottom rounded py-3 coupon-code" data-type="alpha-numeric" 
                                    ...
                                    <div class="col-12">
                                        <div class="form-check text-start my-2">
                                            <input type="checkbox" class="form-check-input bg-primary border-0" id="Transfer-1" name="Transfer" 
                                                value="Transfer" checked disabled
                                            >
    ...
    <script src="<?= asset_versioned('js/public/checkout.js'); ?>" type="module"></script>

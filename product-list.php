<?php
    ...
    $view  = isset($_GET['view']) && is_string($_GET['view']) ? $_GET['view'] : 'category';
    $param = isset($_GET['data']) && is_string($_GET['data']) ? $_GET['data'] : null;

    // Page Products
    $pageProducts = ($view === 'category') ? $productModel->findByCategory($param, $page) : $productModel->findByColor($param, $page);
    ...
    $baseUrl     = "product-list?view={$view}&data={$param}";
?>
...
<head>
    <title><?= SITE_NAME ?> | Product List</title>
                                ...
                                <?php foreach ($groupedCategories as $category): ?>
                                    <li>
                                        <div class="categories-item">
                                            <a href="product-list?view=category&data=<?= urlencode($category['category_name']) ?>">
                                ...
                                <?php foreach ($productColors as $color): ?>
                                    <li>
                                        <div class="product-color-item">
                                            <a href="product-list?view=color&data=<?= urlencode($color['color']) ?>">

...
(async function ($) {
  ...
  */
  ...
  $(document).on("click", ".product-action button", async function () {
    ...
    switch (buttonText) {
      ...
      case "Edit":
        ...
        redirect(
          `/store/${storeId}/product/${productId}/view`,
        );
        break;
      ...
      default:
        redirect(`/store/${storeId}/product/${productId}/view`);
        break;
    }
  });
  ...
  $(".btn-load").on("click", async function () {
    ...
    offset++;
    // Fetch notifications
    await fetchProducts({ page: offset, total: limit, view: "vendor" });
  });
  ...
  // View products
  /*
  $(document).on("click", "tr.content-row", function () {
    const productId = parseInt($(this).data("id"));
    // Open product
    redirect(`./product-view?productId=${productId}&id=${storeId}`);
  });
  */

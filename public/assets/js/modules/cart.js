...
export async function removeFromCart(productId) {
  if (isLoggedIn) {
    // Try server-side add
    try {
      const result = await makeRequest(`/cart/${productId}`, "DELETE", {});
        ...
        <tr class="cart-item table-item item-shopping" data-id="cart-${productId}" data-pid="${productId}">
          ...
          <td>
            <div class="input-group quantity py-4" style="width: 100px;">
              ...
              <input type="text" class="form-control form-control-sm text-center border-0 item-quantity" value="${quantity}">
              <div class="input-group-btn">
